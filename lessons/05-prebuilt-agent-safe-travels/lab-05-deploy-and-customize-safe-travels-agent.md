...
- [ ] Safe Travels template selected  
- [ ] Generative AI enabled  
- [ ] Public website added as knowledge  
- [ ] Test queries validated  
- [ ] Activity Map reviewed  
- [ ] Agent published  
...
Improve the Safe Travels agent by adding:

- A SharePoint travel policy site  
- An internal FAQ document  
- A company travel reimbursement guide  

This will align the agent with internal policies and make it enterprise-ready.
