...
## Planned Lab: IT Helpdesk Declarative Agent

The lab associated with this lesson focuses on building a declarative agent for an internal IT helpdesk scenario.

The agent will eventually:

- Be created using the conversational agent creation experience
- Use instructions to define its IT support role
- Leverage prompts as tools
- Be published to Microsoft 365 Copilot and Microsoft Teams

Knowledge sources and advanced tools will be added in later lessons.

---

## Summary of Current Understanding

At this stage, the following concepts are established:

- Declarative agents extend Microsoft 365 Copilot with custom behavior
- Microsoft Copilot Studio full provides greater extensibility than Copilot Studio lite
- Declarative agents can access enterprise knowledge and external systems
- Copilot Studio supports advanced tooling, model selection, and deployment options
- B2E scenarios are a common and effective use case for declarative agents

---

## Next Steps

The next step is to complete the hands-on lab to build and publish a declarative agent for Microsoft 365 Copilot, starting with instruction definition and prompt-based tooling.
